...
from HunterCat.celery_custom_task import HuntercatTask
...
@app.task(name='subdomain_discovery', queue='main_scan_queue', base=HuntercatTask, bind=True)
...
@app.task(name='osint', queue='main_scan_queue', base=HuntercatTask, bind=True)
...
@app.task(name='screenshot', queue='main_scan_queue', base=HuntercatTask, bind=True)
...
@app.task(name='port_scan', queue='main_scan_queue', base=HuntercatTask, bind=True)
...
@app.task(name='nmap', queue='main_scan_queue', base=HuntercatTask, bind=True)
def nmap(
		self,
		cmd=None,
		ports=[],
...
@app.task(name='waf_detection', queue='main_scan_queue', base=HuntercatTask, bind=True)
...
@app.task(name='dir_file_fuzz', queue='main_scan_queue', base=HuntercatTask, bind=True)
...
@app.task(name='fetch_url', queue='main_scan_queue', base=HuntercatTask, bind=True)
...
@app.task(name='vulnerability_scan', queue='main_scan_queue', bind=True, base=HuntercatTask)
...
@app.task(name='nuclei_individual_severity_module', queue='main_scan_queue', base=HuntercatTask, bind=True)
...
@app.task(name='nuclei_scan', queue='main_scan_queue', base=HuntercatTask, bind=True)
...
@app.task(name='dalfox_xss_scan', queue='main_scan_queue', base=HuntercatTask, bind=True)
...
@app.task(name='crlfuzz_scan', queue='main_scan_queue', base=HuntercatTask, bind=True)
...
@app.task(name='s3scanner', queue='main_scan_queue', base=HuntercatTask, bind=True)
...
@app.task(name='http_crawl', queue='main_scan_queue', base=HuntercatTask, bind=True)
def http_crawl(
		self,
		urls=[],
		method=None,
...
def save_imported_subdomains(subdomains, ctx={}):
	...
	domain = Domain.objects.get(pk=domain_id)
	results_dir = ctx.get('results_dir', HUNTERCAT_RESULTS)
